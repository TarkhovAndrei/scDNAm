...
lo_mm9_to_mm10 = None#LiftOver(os.path.join(os.path.dirname(__file__),  'mm9ToMm10.over.chain'))
lo_mm10_to_mm39 = None #LiftOver(os.path.join(os.path.dirname(__file__),  'mm10ToMm39.over.chain'))
lo_mm10_to_hg19 = None#LiftOver(os.path.join(os.path.dirname(__file__),  'mm10ToHg19.over.chain'))
lo_mm10_to_hg38 = None#LiftOver(os.path.join(os.path.dirname(__file__),  'mm10ToHg38.over.chain'))
